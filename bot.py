...
class PersistentView(discord.ui.View):
    ...
    @discord.ui.button(label="Receive an answer", style=discord.ButtonStyle.primary, custom_id="text_ans")
    ...
    @discord.ui.button(label="Translate the message", style=discord.ButtonStyle.secondary, custom_id="text_translate")
